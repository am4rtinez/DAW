...
function VeureReserves() {
	...
	$('#butVR').removeClass('btn-light').addClass('btn-primary');
	$('#butPU').removeClass('btn-primary').addClass('btn-light');
...
function PantallaUsuari() {
	//marcam els botons de light i primary
	$('#butPU').removeClass('btn-light').addClass('btn-primary');
	$('#butVR').removeClass('btn-primary').addClass('btn-light');
		//canviam els <div> hidden per mostrar el que toca
...
function EnviaForm() {
		...
		if (comprova){
			...
			$('#alertaReserva').html("S'ha gestionat la reserva");
		}		
		$('#alertaReserva').show();
